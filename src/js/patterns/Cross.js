class Cross {
      ...
      "width": {
        ...
        "input": {
          ...
          "params" : [
            ...
            0.3 * (env.table.x.max - env.table.x.min),
            1
          ],
          "class": "slider",
          "displayValue": true
  ...
  draw() {
    ...
    document.querySelector('#pattern-controls > div.pattern-control:nth-child(1) > span').innerHTML = this.config.width.value + " " + this.env.table.units;
    document.querySelector('#pattern-controls > div.pattern-control:nth-child(2) > span').innerHTML = this.config.height.value + " " + this.env.table.units;
